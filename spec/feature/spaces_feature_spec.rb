...
RSpec.describe "Spaces Feature", type: :feature do
  ...
  it "adds and lists spaces" do
    ...
    fill_in "date_from", with: "2022-01-01" # "2022-01-01"
  ...
  it "adds and lists multiple spaces" do
    ...
    fill_in "Date from", with: "2022-01-01"
    fill_in "Date to", with: "2022-01-05"
    click_button "List my Space"
    ...
    fill_in "Date from", with: "2022-05-07"
    fill_in "Date to", with: "2022-05-12"
    click_button "List my Space"
    ...
    fill_in "Date from", with: "2023-02-04"
    fill_in "Date to", with: "2023-02-20"
    click_button "List my Space"
    ...
    expect(page).to have_content "2022-05-07"
    expect(page).to have_content "2022-05-12"

    expect(page).to have_content "Reading"
    expect(page).to have_content "small flat next to the town centre"
    expect(page).to have_content "200"
    expect(page).to have_content "2023-02-04"
  ...
  it "deletes spaces" do
    ...
    expect(page).not_to have_content "2022-05-07"
    expect(page).not_to have_content "2022-05-12"
  ...
  it "updates spaces" do
    ...
    fill_in "Date from", with: "2022-04-03"
    fill_in "Date to", with: "2022-06-07"
    ...
    expect(page).to have_content "2022-06-07"
