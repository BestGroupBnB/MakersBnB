...
RSpec.describe SpacesTable do
  ...
  it "removes spaces" do
    ...
    space_1_id = spaces_table.add(SpaceEntity.new("Mazury", "beautiful house next to Mazury Lac", 100 , "01/01/2022", "05/01/2022"))
    space_2_id = spaces_table.add(SpaceEntity.new("London", "apartament next to the Big Ben", 1000 , "07/05/2022", "12/05/2022"))
    space_3_id = spaces_table.add(SpaceEntity.new("Reading", "small flat next to the town centre", 200 , "04/02/2023", "20/02/2023"))
  ...
  it "updates spaces" do
    ...
    spaces_table.update(space_2_id, "Oxford", "Flat next to University", 350, "03/04/2022", "07/06/2022")
